...
-- Last updated: 24/11/2022 06:24:07 PM
set_prio('Cloak of Averted Crisis', '', 'Filler', 'Thor, Chris')
...
set_prio('Seized Beauty', 'OS/DE', '', 'Ethos, Cluelust')
set_prio('Dying Curse', 'Samme', 'BiS for every caster to save hit elsewhere', 'Aaron, Cypack, Thor, Heasy')
...
set_prio('Fool\'s Trial', '', 'Filler until Quest neck - prio people last in line', 'Sandra, Elguapo, Msg')
...
set_prio('Defender\'s Code', 'Trisp/Hov?', 'bear OS maybe', '')
...
set_prio('Dawnwalkers', 'Verge (if has slayers belt) > Inkies > Koro', 'BIS: Rogue', '')
set_prio('Inexorable Sabatons', 'Trisp OS > OS/DE', 'Fig then OS', 'Fig')
...
set_prio('Ablative Chitin Girdle', 'Fig > Hawkey > Trisp OS', 'BIS: Prot Pal > Blood DK > Prot War', '')
set_prio('Sinner\'s Bindings', 'Coonixx > Hovden > Rogues if they aren\'t using T6 bracers', 'BiS: Feral, Rogue', '')
...
set_prio('Girdle of Chivalry', 'Tobs > Koro until leather belt?', 'BIS Unholy > Frost DK - depending on setup, ret', 'Msg, Greetings')
...
set_prio('Legplates of the Lost Protector', '', 'Enhance > Hunter > Resto > Fury', 'Died, Beanpole, Pili, Cluelust, Trisp OS, Elguapo, Died OS')
set_prio('Legplates of the Lost Vanquisher', '', 'Frost DK > Rogue > Mage', 'Greetings, Tobs, Inkies, Verge, Jules, Heasy, Samme, Coonixx, Hawkey, Msg OS')
...
set_prio('Breastplate of Tormented Rage', 'Trisp OS?', 'not better than tier', '')
...
set_prio('Legguards of the Apostle', 'OS/DE', '', '')
...
set_prio('Girdle of Unity', 'OS/DE', '', '')
...
set_prio('Mantle of the Lost Protector', 'RFI or OS > OS', 'Enhance > ?? (Arms, Hunter, Resto)', 'Died, Trisp, Cluelust, Pili, Beanpole, Died, Thor OS')
set_prio('Mantle of the Lost Vanquisher', 'OS', 'Balance > Frost DK > Blood DK > Rogue > Mage', 'Chris, Greetings, Tobs, Hovden, Samme, Verge, Hawkey?, Inkies, Jules, Heasy, Chris OS')
...
set_prio('Breastplate of the Lost Conqueror', 'Sterile', 'Tank > DPS > Healer', 'Fig, Aaron, Cypack, Koro, Jess')
set_prio('Breastplate of the Lost Protector', '', 'Enhance > Ele > Resto > Arms', 'Died, Thor, Cluelust, Trisp?, bean')
...
set_prio('Damnation', 'Jules > OS/DE', '', '')
...
set_prio('Heroic Key to the Focusing Iris', 'Samme', 'Prot Pally > Demo > Dps Warrior = Aff = Ele >= Hunter = Enhance = Ret = Shadow = Boomy = Fire = Arcane > Unholy DK > Frost DK > Hpal > Hpriest = Disc > Rsham > Prot Warrior > Rdruid = Bear = Blood DK', 'Fig, Thor, Trisp, Pili, Chriski, Zlops, Sweet Azz')
...
set_prio('Gatekeeper', 'Hawkey > Trisp > OS/DE', 'fig>hawkey bis', 'Fig')
...
set_prio('Envoy of Mortality', 'Bean > Elguapo > Trisp > Rogues', 'BiS: Hunter and Rogue - consider pili for dwarf gun prio', 'Pili')
...
set_prio('Crown of the Lost Vanquisher', 'Coonixx > Hov > Mages (ask Aaron)', '', 'Chris, Hawkey, Inkies, Verge')
...
set_prio('Fury of the Five Flights', 'Beanpole > Inkies/Verge/Msg BiS if no DMC', 'BiS: Ret, Trap-weave Hunter', 'Sandra, Pili, Elguapo')
set_prio('Chestplate of the Great Aspects', 'OS/DE', 'Filler', '')
set_prio('Wyrmrest Band', 'Saicere > RFI/OS', 'BiS: Disc, top 4 option for the other healers', 'Sterile, Ethos, Cluelust')
set_prio('Council Chamber Epaulets', 'OS/DE', 'Filler', '')
set_prio('Mantle of the Eternal Sentinel', 'Sell', 'BoE, good for Ele if they dont need hit, filler for HPal/RSham/Balance', '')
...
set_prio('Gauntlets of the Lost Conqueror', 'Cypack > Hpals > Spriests', 'fig > demo > hpal > spriest > ret = aff > disc', 'Fig, Icantwalk, Shazz, Aaron')
set_prio('Gauntlets of the Lost Protector', '', 'Enh > ??', 'Died, Trisp, Thor, Died, Elguapo, Died OS')
set_prio('Gauntlets of the Lost Vanquisher', 'Mages > Filler for Feral > Hawkey', 'Balance > Blood DK > Frost DK > Arcane', 'Chris, Greetings, Tobs, jules')
set_prio('Dragonstorm Breastplate', 'Trisp OS?', 'Blood?', 'Greetings')
...
set_prio('Leggings of the Honored', 'Coon > Inkies', 'BiS: Feral, and an option for Rogue/Ret', 'Hov')
...
set_prio('Chestguard of the Recluse', 'Coonixx > Verge > Trisp', 'BiS: Cat, Rogue, Arms, Fury', 'Inkies, Hovden')
set_prio('Boots of Renewed Flight', 'Beanpole', 'BIS: Hunter', 'Pili, Elguapo')
set_prio('Melancholy Sabatons', 'Koro > Tobs', 'BiS: Arms / Frost / Unholy / Ret', 'Trisp, Greetings, Msg')
set_prio('Frosted Adroit Handguards', 'Big Coon > Hovden', 'BiS: Rogue, Cat, Ret, Arms, Hunter', 'Pili, Beanpole, Elguapo')
...
set_prio('Legplates of Sovereignty', 'Trisp OS > OS/DE', 'BiS: Blood and Prot', 'Fig, Hawkey')
...
set_prio('Arcanic Tramplers', '', 'BiS: Disc, Spriest, Arcane, Demo, Aff, Balance, RDruid', 'Azz, Zeforr')
...
set_prio('Unravelling Strands of Sanity', 'Chris > OS/DE', 'BiS: Resto Druid', '')
