...
-- Last updated: 17/11/2022 06:19:24 PM
...
set_prio('Forethought Talisman', 'Ask if Hpals want, else OS', 'BiS throughput after Illustration of the Dragon Soul', 'Ethos, Cluelust')
...
set_prio('Strong-Handed Ring', '', 'BiS: Hunter, Rogue', 'Inkeyes, Verge, Beanpole, Pili, Died, Elguapo')
...
set_prio('Footwraps of Vile Deceit', '', 'BiS: Feral, Rogue', 'hov, coonixx')
...
set_prio('Mantle of the Lost Vanquisher', '', 'Balance > Frost DK > Blood DK > Rogue > Mage', 'Chris, Greetings, Tobs, Hovden, Samme, Verge, Hawkey?, Inkies, Jules, Heasy')
...
set_prio('Heroic Key to the Focusing Iris', 'Sweet Azz > Samme', 'Prot Pally > Demo > Dps Warrior = Aff = Ele >= Hunter = Enhance = Ret = Shadow = Boomy = Fire = Arcane > Unholy DK > Frost DK > Hpal > Hpriest = Disc > Rsham > Prot Warrior > Rdruid = Bear = Blood DK', 'Fig, Thor, Trisp, Pili, Chriski, Zlops')
...
set_prio('Boundless Ambition', 'Fig', 'BiS: Blood and Prot (Armor)', 'Hawkey, hov')
...
set_prio('Journey\'s End', 'Hunters', 'BiS: Feral/Hunter - Both have 25m Heigen', 'Coonixx')
...
set_prio('Pennant Cloak', '', 'Highest ilvl cloak this phase + only one with a socket, bis for basically every SP user, reward pumpers', '')
...
set_prio('Legplates of Sovereignty', '', 'BiS: Blood and Prot', 'Fig, Hawkey')
