...
function FilthyPrio.buildOfficerPrio()
	...
	-- Last updated: 13/03/2023 12:27:20 PM
	...
	FilthyPrio.SetPrio('Comet\'s Trail', 'Check sheet', '', 'Verge')
	FilthyPrio.SetPrio('Constellus', 'Ethos/Cluelust > Jess > Sterile > Chris',
	...
	FilthyPrio.SetPrio('Pharos Gloves', 'Ask Aaron > Hpals', 'BiS: Aff, Spriest, Mage, Boomy, Ele, HPal', 'Jules')
	FilthyPrio.SetPrio('Planewalker Treads', 'RFI/OS', 'Acceptable BiS RSham', 'Cluelust')
	FilthyPrio.SetPrio('Reply-Code Alpha', 'Coonixx', 'BIS! ARP Prio: War/Hunter/Feral/Enh/Rogue/Frost',
	'Aaron, Trisp, Pili')
	FilthyPrio.SetPrio('Sabatons of Lifeless Night', 'Check sheet', 'BiS: Fury, Ret, Frost, Unholy', 'Greetings, Tobs')
	FilthyPrio.SetPrio('Solar Bindings', 'Dof > Trisp > Coon Cheese? > Sandra?', 'BiS: Ass Rogue, Fury > Feral > Ret', '')
	...
	FilthyPrio.SetPrio('Fang of Oblivion', 'Inkies Ass?', '', 'Dof Offhand?')
	FilthyPrio.SetPrio('Dreambinder', 'elg > BP ', '', 'Koonix, Pili, Brick')
	...
	FilthyPrio.SetPrio('Insurmountable Fervor', 'Tobs/Trisp/Sandra?', 'Filler - Frost/Ret/Unholy/Fury', 'Msg')
	...
	FilthyPrio.SetPrio('Raiments of the Iron Council', '', 'Filler', 'Aaron')
	...
	FilthyPrio.SetPrio('Legplates of the Wayward Conqueror', 'Ethos > Zef Healing > OS/DE',
	'Spriest > Disc > Ret > Demo > Aff > HPal', 'Zef, Koro, Koro, Cypack, Jess, Sterile, Aaron')
	FilthyPrio.SetPrio('Legplates of the Wayward Protector', 'Elg/Pili? > Cluelust DPS > OS/DE',
	'Ele > RSham > Enh > Hunter', 'Thor, Cluelust, Died, Brickie')
	FilthyPrio.SetPrio('Legplates of the Wayward Vanquisher', 'Chris Resto > Hawkey DPS > OS/DE',
	...
	FilthyPrio.SetPrio('Frostplate Greaves', 'RFI/OS', 'Filler', '')
	...
	FilthyPrio.SetPrio('Heart of Iron', 'Hawkey', 'Big fucken stam - anyone but Hawkey', 'Hov')
	...
	FilthyPrio.SetPrio('Bracers of Unleashed Magic', 'RFI/DE', 'Filler, who missed out on Unsullied and needs hit?',
	'Zef, Ethos DPS')
	...
	FilthyPrio.SetPrio('Giant\'s Bane', 'Hunter? > Rogue/War?', 'Hunter with a shit bow - Elg or BP', 'Elg')
	...
	FilthyPrio.SetPrio('Titanguard', 'Hawkey? > RFI/DE', '', 'Hov, Trisp Tank')
	...
	FilthyPrio.SetPrio('Golden Saronite Dragon', 'Verge for Cumbat? > Bin it', 'BIS Combat and Enhance', 'Inkies, Died')
	FilthyPrio.SetPrio('Pendant of Fiery Havoc', 'Ask Aaron', 'BiS: Casters casting spells n shit', 'Cypack, Jules, Oxi')
	FilthyPrio.SetPrio('Plated Leggings of Ruination', '', 'BiS: Ret, Frost, Unholy', '')
	...
	'Trisp, Died, Elguapo, Pili, Bricko, Trisp OS, Cluelust, ')
	FilthyPrio.SetPrio('Gauntlets of the Wayward Vanquisher', 'Hawkey DPS > OS/DE',
	'Hawkey > Feral > Frost > Ass > RDruid', 'Hawkey, Coonixx, Greetings, Tobs, Inkies, Verge, Chris Resto, Jules')
	...
	FilthyPrio.SetPrio('Crown of Luminescence', 'Ask Aaron', 'BiS Demo, Aff, Arcane, Boomy', 'Cypack')
	...
	FilthyPrio.SetPrio('Living Flame', 'Ask Aaron', 'Aaron then those who didnt get Dying Curse?', 'Oxi, Jules')
	...
	FilthyPrio.SetPrio('Saronite Mesh Legguards', ' Trisp?', 'Filler - all hunters have', 'Elguapo, Brickie, Pili')
	...
	FilthyPrio.SetPrio('Crown of the Wayward Vanquisher', 'Coon Daddy? > Hawkey DPS? > DKs Tanking? > Bin it',
	'Hawkey > Mage?* > Boomy?* > Feral > Frost > Ass > RDruid',
	'Hawkey, Chris, Tobs, Heasy, Jules, Greetings, Verge, Chris Resto')
	...
	FilthyPrio.SetPrio('Sif\'s Promise', 'RFI/DE', 'Solid filler for Ret, Unholy, Frost, Fury', 'Tobs, Msg')
	...
	FilthyPrio.SetPrio('Metallic Loop of the Sufferer', 'RFI/DE', 'Filler for Enh, Rogue, Hunter, Pally', 'Verge')
	FilthyPrio.SetPrio('Ring of the Vacant Eye', 'RFI/DE', 'Who missed Naxx rings and needs hit?', 'Aaron, Oxi')
	FilthyPrio.SetPrio('The General\'s Heart', 'RFI/DE', 'Farming spec', 'Hov')
	FilthyPrio.SetPrio('Scepter of Lost Souls', '', 'BiS caster non-hit wand?', '')
	FilthyPrio.SetPrio('Lotrafen, Spear of the Damned', 'Mr Pole > Elguapo', 'Hunter 2nd BiS', 'Brickie')
	FilthyPrio.SetPrio('Flare of the Heavens', 'Ask Aaron', 'BiS: Demo, Aff, Mage, Spriest, Boomy', 'Aaron , Heasy, Zef')
	...
	FilthyPrio.SetPrio('Gloves of the Steady Hand', 'Hunters first - check sheet', 'BiS: Hunter > Ret > Unholy', '')
	...
	'Filler for Rogue, Enhance, Frost, Ret', '')
	...
	'Hov, zef, Ethos, Aaron, Jess, Sandra, Sterile')
	FilthyPrio.SetPrio('Mantle of the Wayward Protector', 'Cluelust (has 10) > Pili or Elg? > Cluelust DPS',
	'Ele > RSham > Enh > Warrior > Hunter', 'Thor (has 10), Died, Trisp')
	FilthyPrio.SetPrio('Mantle of the Wayward Vanquisher',
	'Chris Resto > Coonixx (for set, but not bis) > Hawkey DPS > Greetings Tank',
	'Hawkey > Mage > Boomy > Feral?* > Frost > Unholy > RDruid', 'Hawkey, Jules, Greetings, Heasy, Msg, Tobs, Chris')
	...
	FilthyPrio.SetPrio('Seal of the Betrayed King', 'Hawkey DPS > RFI/DE', 'BiS: Frost, Unholy, Ret',
	'Tobs, Greetings, Msg, Sandra')
	...
	FilthyPrio.SetPrio('Mimiron\'s Head', '', '', 'Jess, Cypack')
	...
	FilthyPrio.SetPrio('Shroud of Alteration', '', '', 'Sterile')
