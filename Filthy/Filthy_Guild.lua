...
function FilthyPrio.buildOfficerPrio()
	...
	-- Last updated: 09/02/2023 05:49:13 PM
	...
	FilthyPrio.SetPrio('Iron-studded Mantle', '', '', 'Pili')
	...
	FilthyPrio.SetPrio('Stormrune Edge', 'Hunters without Dreambinder', 'BP has Betrayer - Brickie/Elg has Journey\'s End',
		'')
	...
	FilthyPrio.SetPrio('Gauntlets of the Wayward Conqueror',
		'Aaron (has 10) > Sterile > Give people who need 4pc or waiting for Pharos Gloves', 'Ret > Demo > HPals',
		'Sandra, Jess')
	...
	FilthyPrio.SetPrio('Guiding Star', 'Cluelust > Jess/Sterile', 'Filler, People who missed out on KT Torch', '')
	...
	FilthyPrio.SetPrio('Lotrafen, Spear of the Damned', 'Hunters without Dreambinder',
		'BP has Betrayer - Brickie/Elg have Journey\'s End', '')
