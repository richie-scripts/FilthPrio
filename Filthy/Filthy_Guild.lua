...
function FilthyPrio.buildOfficerPrio()
	...
	-- Last updated: 07/02/2023 08:20:43 AM
	...
	FilthyPrio.SetPrio('Boundless Gaze', 'BP > Hunter', 'Recon hates this item', '')
	...
	FilthyPrio.SetPrio('Dreambinder', 'Elguapo > BP or Brick', '', 'Koonix, Pili')
	...
	FilthyPrio.SetPrio('Skyforge Crossbow', 'Beanpole > Elg or Brickie', 'BIS: Hunters > Rogue/War', 'Pili')
	...
	FilthyPrio.SetPrio('Siren\'s Cry', 'Mr Pole > Elguapo', '', 'brick')
	...
	FilthyPrio.SetPrio('Stormrune Edge', 'Hunter', 'BP has Betrayer - Brickie/Elg has Journey\'s End', '')
	...
	FilthyPrio.SetPrio('Greaves of Swift Vengeance', 'Elguapo', '', '')
	FilthyPrio.SetPrio('Sapphire Amulet of Renewal', '', 'BiS: Demo, Arcane, RDruid', '')
	FilthyPrio.SetPrio('Shoulderpads of the Intruder', 'Dof > Big Feral Coon', '', 'Inkies')
	...
	FilthyPrio.SetPrio('Gauntlets of Ruthless Reprisal', 'Msg > Offspec UH', '', '')
	FilthyPrio.SetPrio('Leggings of the Lifetender', 'Chris > RFI/OS', '', '')
	FilthyPrio.SetPrio('Legplates of the Wayward Conqueror',
		'Cypack > Jess > Sterile > Ethos (has 10m) > Aaron (has 10m) > Zef Healing', 'Spriest > Disc > Ret > Demo > Aff > HPal'
		, 'Zef, Koro, Koro')
	FilthyPrio.SetPrio('Legplates of the Wayward Protector', 'Thor (has 10) > Died > Mr Pole > Elg (has 10) > Cluelust DPS'
		, 'Ele > RSham > Enh > Hunter', 'Cluelust, Brickie, Brickie')
	...
	FilthyPrio.SetPrio('Bladetwister', 'Dof Offhand > Inkies Offhand', '', 'Dof')
	FilthyPrio.SetPrio('Bronze Pendant of the Vanir', 'Hov/Hawkey > Trisp OS > Coonixx OS > Greetings OS', 'BiS Mitigation'
		, '')
	...
	FilthyPrio.SetPrio('Breastplate of the Wayward Protector', 'Died > Mr Pole > Elg (has 10) > Pili (has 10) > OS',
		'Ele > RSham > Enh > Warrior > Hunter', 'Thor, Cluelust, Trisp, Brickie')
	...
	FilthyPrio.SetPrio('Frost-bound Chain Bracers', 'Hunter', 'Hunter needing hit?', '')
	...
	FilthyPrio.SetPrio('Bindings of Winter Gale', 'Thor > Cluelust > HPals', 'BiS Ele, RSham, HPal, also good for Enh???',
		'')
	FilthyPrio.SetPrio('Drape of Icy Intent', 'Dof > Inkies > Died', 'BiS Rogue/Enhance', '')
	...
	FilthyPrio.SetPrio('Cindershard Ring', 'Verge > Inkies > Hunter', 'Filler for Rogue/Feral/Hunter', 'Koonix')
	FilthyPrio.SetPrio('Flamestalker Boots', 'Coonixx if no crafted', '', '')
	FilthyPrio.SetPrio('Flamewrought Cinch', 'Chris', 'Filler', '')
	FilthyPrio.SetPrio('Girdle of Embers', 'Greetings > Msg', '', '')
	...
	FilthyPrio.SetPrio('Worldcarver', 'OS/DE', '', '')
	...
	FilthyPrio.SetPrio('Shoulderpads of the Monolith', 'Verge/Coonixx? > RFI/DE', '', 'Inkies')
	...
	FilthyPrio.SetPrio('Boots of Fiery Resolution', 'Ask Aaron - because he doesn\'t update the sheet > Ethos > Chris Resto'
	...
	FilthyPrio.SetPrio('Plated Leggings of Ruination', 'Msg', 'BiS: Ret, Frost, Unholy', '')
	...
	FilthyPrio.SetPrio('Gauntlets of the Wayward Conqueror',
		'Aaron (has 10) > Sterile > RFI - probs give people waiting for Pharos Gloves', 'Ret > Demo > HPals', 'Sandra, Jess')
	...
	FilthyPrio.SetPrio('Gauntlets of the Wayward Vanquisher',
		'Coonixx? > Rogues > Chris Resto > Hawkey DPS > Greetings Tank', 'Hawkey > Feral > Frost > Ass > RDruid',
		'Hawkey, Greetings, Tobs')
	...
	FilthyPrio.SetPrio('Armbands of Bedlam', 'Tobs', 'BiS: Frost, Unholy, Ret', '')
	FilthyPrio.SetPrio('Conductive Seal', '', 'BiS: Demo, Aff, Mage, Boomy, Spriest, Ele, Disc', '')
	FilthyPrio.SetPrio('Crown of Luminescence', 'Aaron > Ask Aaron - because he doesn\'t update the sheet',
		'BiS Demo, Aff, Arcane, Boomy', '')
	...
	FilthyPrio.SetPrio('Razorscale Shoulderguards', 'RFI/DE', '', 'Hov OS')
	FilthyPrio.SetPrio('Saronite Mesh Legguards', 'Pili? >  Trisp', '', 'Elguapo, Brickie')
	FilthyPrio.SetPrio('Shackles of the Odalisque', 'Ask Aaron - because he doesn\'t update the sheet',
		'2nd BiS, give to those without Unsullied Cuffs?', 'Cypack')
	FilthyPrio.SetPrio('Sigil of Deflection', 'Hawkey for Algalon?', '', '')
	...
	FilthyPrio.SetPrio('Crown of the Wayward Conqueror', 'Hov Holy?', 'Prot > Shadow > Disc > Ret?* > HPal',
		'Hov, Zef, ethos, Jess, Sterile, Zef Heals, Cypack, Aaron')
	FilthyPrio.SetPrio('Crown of the Wayward Protector',
		'Trisp (has 10) > Elg (has 10) > Mr Pole > Cluelust DPS > Trisp Tank?', 'Ele > RSham > Warrior > Hunter',
		'Thor, Cluelust, Brickie, Pili')
	...
	FilthyPrio.SetPrio('Vulmir, the Northern Tempest', 'Greetings/Tobs > Hawkey DPS', '2nd BiS Frost until 10m Hard Mode',
		'')
	...
	FilthyPrio.SetPrio('Boots of the Underdweller', 'Msg > Tobs > Greetings',
	...
	FilthyPrio.SetPrio('Lotrafen, Spear of the Damned', 'Hunter', 'BP has Betrayer - Brickie/Elg have Journey\'s End', '')
	FilthyPrio.SetPrio('Flare of the Heavens', 'Aaron  > Ask Aaron - because he doesn\'t update the sheet',
		'BiS: Demo, Aff, Mage, Spriest, Boomy', '')
	FilthyPrio.SetPrio('Handwraps of the Vigilant', 'Cypack > Ask Aaron - because he doesn\'t update the sheet',
		'BiS: Disc, filler until Pharos for Spriest/casters?', '')
	FilthyPrio.SetPrio('Pendulum of Infinity', 'Elg', 'BiS: Rogue, Feral, Hunter, Enhance, Fury, Ret', '')
	...
	FilthyPrio.SetPrio('Quartz-studded Harness', 'HPal/OS > RFI/DE', 'Filler', 'Cluelust')
	FilthyPrio.SetPrio('Sandals of Rash Temperament', '', 'Decent filler, Hit', '')
	FilthyPrio.SetPrio('Shoulderplates of the Deconstructor', '', '', '')
	FilthyPrio.SetPrio('Sigil of the Vengeful Heart', 'Msg > OS/DE', '', '')
	...
	FilthyPrio.SetPrio('Gloves of the Steady Hand', 'Mr Pole', '', '')
	...
	FilthyPrio.SetPrio('Sorthalis, Hammer of the Watchers', 'Hov > Msg?', '', '')
	...
	FilthyPrio.SetPrio('Blood of the Old God', 'Dof > Inkies? > Sandra? (too much hit)', '', '')
	FilthyPrio.SetPrio('Chestguard of Insidious Intent', 'Hunters > Maybe BP?', '', '')
	...
	FilthyPrio.SetPrio('Mantle of the Wayward Vanquisher',
		'Msg (has 10) > Tobs (has 10) > Chris (may not use yet)? > Chris Resto > Coonixx (not bis) > Hawkey DPS > Greetings Tank'
		, 'Hawkey > Mage > Boomy > Feral?* > Frost > Unholy > RDruid', 'Hawkey, Jules, Greetings (for 4set), Heasy (has 10)')
	...
	FilthyPrio.SetPrio('Dark Edge of Depravity', 'Hunter > Papa Coon for Tanking?',
		'BP has Betrayer - Brickie/Elg have Journey\'s End', 'Sandra')
	...
	FilthyPrio.SetPrio('Mimiron\'s Head', 'Not tobs cause he was over 9 hours late to do loot with trisp > Definitely Tobs'
		, '', '')
